...
MODEL_CONFIG = {
  ...
  'moving_average': 0.9999#0.0,  # 0.0 will disable model moving average, default 0.9999
}
...
#  'optimizer_config': {'optimizer': 'Adam'},
  ...
  'clip_gradients':10.0,#None,#5.0,#5.0,
...
if DEBUG:
  ...
  @ex.named_config  
  def sfc():
    run_name = 'SFC-2-momentum-lr0.0001-clip-zeroinit-moving_average-from-scratch'
