...
#  'optimizer_config': {'optimizer': 'Momentum'},
  ...
  'lr_config': {'policy': 'exponential',#,#
                'initial_lr': 0.0001,#0.00001 for 2 #0?001for no description # 0.01 for conv2 
        #        'initial_lr1': 0.001,
  ...
  'clip_gradients':None,#100.0,#None,#50.0,#None,#5.0,#5.0,
...
#    imdb_dir = "/home/v-chaoqw/MYSFC-ORI/workspace/train_imdb.pickle"
  ...
  @ex.named_config  
  def sfc():
    run_name = 'SFC-2-fixqian-val-noclip-lr0.0001'
