...
#  'optimizer_config': {'optimizer': 'Adam'},
  ...
  'lr_config': {'policy': 'exponential',#,#
                'initial_lr': 0.0005,#0.00001 for 2 #0?001for no description # 0.01 for conv2 
                'initial_lr2': 0.05,
                'decay_steps':10000,
  ...
  'clip_gradients':20.0,#None,#5.0,#5.0,
...
if DEBUG:
  ...
  @ex.named_config  
  def sfc():
    run_name = 'SFC-2-momentum-lr0.0005-lastlr0.05-clip20'
