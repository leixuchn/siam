...
DEBUG = False
BATCH_SIZE = 8#8  # training batch size
...
MODEL_CONFIG = {
  ...
  'loss_type': 'L2',#'Cross_entropy',

  'z_embed_size': 6,
  'x_embed_size': 22,

  # It is often beneficial to track moving averages of the trained parameters.
  'moving_average': 0.0,  # 0.0 will disable model moving average, default 0.9999
}
...
if DEBUG:
  ...
  @ex.named_config
  def sfc():
    run_name = 'SFC-2-lastaddlayer-adm-0.001-l2loss'
