...
#  'optimizer_config': {'optimizer': 'Momentum','momentum':0.9,'use_nesterov':False,},
  ...
  'lr_config': {'policy': 'exponential',#,#
                'initial_lr': 0.1,#0.00001 for 2 #0?001for no description # 0.01 for conv2 
        #        'initial_lr1': 0.001,
                'decay_steps':7000,#10000,
                #'num_epochs_per_decay': 25,
                'lr_decay_factor': 0.1,
                'staircase': True, },

  # If not None, clip gradients to this value.
  'clip_gradients':50.0,#None,#50.0,#None,#5.0,#5.0,
