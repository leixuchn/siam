...
MODEL_CONFIG = {
  ...
  'prefetch_config_train': {'input_imdb':"/home/v-chaoqw/MYSFC-ORI/workspace/train_imdb.pickle",  #!need defined for different configuration
  ...
  'prefetch_config_val': {'input_imdb':"/home/v-chaoqw/MYSFC-ORI/workspace/val_imdb.pickle",
...
TRAIN_CONFIG = {
  ...
  'optimizer_config': {'optimizer': 'Momentum','momentum':0.9,'use_nesterov':True,},
#  'optimizer_config': {'optimizer': 'Momentum'},
  # Learning rate configs 
  'lr_config': {'policy': 'exponential',#,#
                'initial_lr': 0.01,#0.00001 for 2 #0?001for no description # 0.01 for conv2 
        #        'initial_lr1': 0.001,
  ...
  'clip_gradients':100.0,#None,#100.0,

  # Frequency at which loss and global step are logged
  'log_every_n_steps': 10,

  # Frequency to save model
  'save_model_every_n_step': 2500,
...
if DEBUG:
  ...
  def configurations():
    ...
    train_config['save_dir'] = osp.join(log_dir, 'track_model_checkpoints', checkpointfrom)
...
#    imdb_dir = "/home/v-chaoqw/MYSFC-ORI/workspace/train_imdb.pickle"
  ...
  @ex.named_config  
  def sfc():
    checkpointfrom='SFC-only'
    run_name = 'SFC-clip-10-10-test1111'
