...
ROOT_DIR="/bscratch/v-chaoqw/"
sys.path.append(ROOT_DIR)

from inference.inference_utils import get_crops,  convert_bbox
...
def get_annotation_save_directory(save_dir, split, subdir, video):
  subdir_map = {'ILSVRC2015_VID_train_0000': 'a',
                'ILSVRC2015_VID_train_0001': 'b',
                'ILSVRC2015_VID_train_0002': 'c',
                'ILSVRC2015_VID_train_0003': 'd',
                '': 'e'}
  return osp.join(save_dir, 'Annotations', 'VID', split, subdir_map[subdir], video)
...
def write_xml(annotationname,savename,offsetx,offsety):
  root_name = ET.Element("Annotation")
  dict_new={}
  dict_new["folder"]=savename 
  dict_new["offsetx"]=offsetx
  dict_new["offsety"]=offsety 
  ...
  with open(annotationname, 'w+') as fs:
...
if __name__ == '__main__':
  vid_dir = osp.join(ROOT_DIR, 'ILSVRC2015')
  ...
  save_dir = 'ILSVRC2015-VID-Curation-notcenter'
